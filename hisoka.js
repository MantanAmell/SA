...
const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
	  ...
	  // Anti Link
        ...
        m.reply(`「 ANTI LINK 」\n\nGroup telah di pasang cctv, maaf kamu akan di tendang dari group!`)
        if (!isBotAdmins) return m.reply(`Ehh lupa bot bukan admin T_T`)
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c73fc9d08267295a0fcaf.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot Rental Prices\n⌕ 15k Per Group via E-Walet 1 Month\n⌕ 20k via pulsa 1 Month\n\n Premium Price Bot\n⌕ 10k per User 1 bulan\n\nPayment can be via Paypal/link aja/pulsa\n\nFor more details, you can chat with the owner` }, { quoted: m })
            }
            break
...
`
	                let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://instagram.com/mardy_store.tzy'
                                }
                            }]
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            case 'join': {
                if (!isCreator) throw mess.owner
                if (!text) throw 'Kirim Link Group!'
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://chat.whatsapp.com/K9rqlnfWifHCkjcLKekzxA'
                                }
                            }]
...
Saya adalah ${botname}, yang ingin menjadi asisten anda
